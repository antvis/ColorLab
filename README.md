...
Color is a critical strategic asset in product front-end design, directly influencing user perception and business outcomes.

- <ins>Builds Brand Identity & Trust</ins>: Consistent color schemes increase brand recognition by up to 80%, fostering user familiarity and credibility.
- <ins>Guides User Behavior & Usability</ins>: Strategic color contrast directs attention to key actions (like primary buttons), improving navigation and task completion rates.
- <ins>Evokes Emotion & Shapes Perception</ins>: Colors trigger specific psychological responses, enabling designers to create desired experiences—from calmness (blue) to urgency (red).
- <ins>Enhances Accessibility & Inclusivity</ins>: Proper color contrast ensures information is perceivable by users with visual impairments, expanding market reach and complying with legal standards.
...
```bash
# Clone the repo
$ git clone git@github.com:antvis/ColorLab.git
