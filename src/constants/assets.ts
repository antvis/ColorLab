...
const WassilyKandinskyList = [
  wassilykandinsky1.palettes[0] as CategoricalPalette,
  wassilykandinsky2.palettes[0] as CategoricalPalette,
  wassilykandinsky3.palettes[0] as CategoricalPalette,
];

const ASSETS: ColorSchema = {
  brandName: "colorLab",
  palettes: [
    ...WassilyKandinskyList,
    {
      name: "AntV10",
      semantic: null,
      type: "categorical",
